...
console.log(createMenuItem('Salad', 6, 'snack'));
console.log(createMenuItem('cheesecake', 10, 'dessert'));
...
reviews[7].feedback = 'this place is chill with really cool people, freat for getting work done on weekdays';
